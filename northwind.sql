...
--Tabelas e Dados para a seção de Joins
...
INSERT INTO departamentos (dept_id, dept_nome) VALUES
(1, 'RH'),
(2, 'Marketing'),
(3, 'TI'),
(4, 'Financeiro');

INSERT INTO funcionarios (emp_id, emp_nome, dept_id) VALUES
(1, 'Alice', 1),
(2, 'Bob', 3),
(3, 'Clara', 2),
(4, 'David', NULL), 
...
CREATE TABLE contabilidade.despesas (
...
CREATE TABLE contabilidade.receitas (
...
INSERT INTO rh.funcionarios (nome, sobrenome, departamento_id) VALUES
('João', 'Silva', 1),
('Maria', 'Fernandes', 2),
('Carlos', 'Moraes', 3);

INSERT INTO contabilidade.despesas (departamento_id, valor, data) VALUES
(1, 500.00, '2023-05-01'),
(2, 300.00, '2023-05-02'),
(3, 450.00, '2023-05-03');

INSERT INTO contabilidade.receitas (valor, data) VALUES
(1200.00, '2023-05-01'),
(800.00, '2023-05-02');